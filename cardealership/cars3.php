...
<nav class="navbar navbar-expand-lg navbar-dark bg-blue">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item  active">
                    <a class="nav-link disabled" href="./cars.php">CarDealerships</a>
                </li>
    ...
    $var = $_POST['idDealership'];

    $sql = "SELECT idDealership, D_Name, D_Address,D_email, Since, Rating, Sold FROM dealership WHERE idDealership = $var";
...
<?php
                                    $sql = "SELECT * FROM car WHERE idDealership = $var";
                                    $result = mysqli_query($connection , $sql);
...
{
    ?>
                                <div class="card card_1" style="height: 350px ; width: 300px">
